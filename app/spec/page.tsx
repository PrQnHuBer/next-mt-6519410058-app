    ...
    <main className="min-h-screen flex items-center justify-center p-6 bg-[#1a1a1a] font-['Libre_Franklin']">
      <div className="relative w-full max-w-7xl flex flex-col lg:flex-row items-center justify-between gap-12 text-white">
        ...
        <div className="flex-grow max-w-2xl space-y-8 lg:ml-12">
          <h2 className="text-4xl font-light italic">My <span className="text-orange-500 font-bold not-italic">Specializations</span></h2>
          
          <div className="space-y-4">
            {specs.map((item, idx) => {
              const Icon = item.icon;
              return (
                <div key={idx} className="group p-8 border border-gray-800 rounded-3xl hover:border-orange-500 transition-all duration-300 relative flex justify-between items-start">
